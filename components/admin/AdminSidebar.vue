    ...
    <div :class="['sidebar-main', isCollapsed ? 'collapsed' : '']">
      <div :class="['sidebar-header', isCollapsed ? 'collapsed' : '']">
        <img
          ...
          src="../../public/static/images/atd_solucije.png"
          alt="logo"
          ...
          >
            <nuxt-link
              ...
              :class="[
                'nuxtlink-form',
                'opci',
                isActiveRoute(link.to) ? 'active' : 'inactive',
                isCollapsed ? 'collapsed' : '',
                !link.available ? 'disabled' : '',
              ]"
              :to="link.available ? link.to : '#'"
            >
              <font-awesome-icon
                v-if="link.icon"
...
const sections = ref([
  ...
  },
  {
    ...
    links: [
      {
        label: "Kalkulator procjene klimatskih rizika",
        to: "/admin/kpkr",
        image: "../static/images/kpkr_logo_slim.svg",
        isActive: false,
        available: false,
      },
      {
        label: "Kalkulator emisija stakleničkih plinova",
        to: "/admin/kesp",
        image: "../static/images/kesp_logo_slim.svg",
        isActive: false,
        available: false,
      },
    ],
