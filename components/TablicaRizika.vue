...
.th {
    /* font-weight: bold; */
    border-right: 1px dashed #a6c9ec;
...
.db {
    border: #a6c9ec 1px dashed;
}

.db-r {
    border-right: #a6c9ec 1px dashed;
}

.db-l {
    border-left: #a6c9ec 1px dashed;
}

.db-t {
    border-top: #a6c9ec 1px dashed;
}

.db-b {
    border-bottom: #a6c9ec 1px dashed;
}
